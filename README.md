...
# 13回目
paiza.ioで検索したり、地図を表示したりしてみましょう。

## 作業手順
### 下準備
1. Webブラウザーを使って、googleやbingで検索する
2. アドレスバーに表示される文字列を観察
3. 検索するためのURLを推測する
4. 自分で作成した文字列をWebブラウザーのアドレスバーに入力して、検索ができるか確認する

### 実装
1. javaでHTTP通信をする方法を検索する
2. paiza.ioで、入力欄に入力したURLにアクセスして、戻り値を出力するプログラムを作る
3. アクセスするURLを下準備で調べたURLを参考にして、入力欄の値を検索するように書き換える
以上で完成。

### 完成したら
同じ手順で、入力欄に地名を入力して実行すると、Google Mapsで入力した地名の地図を表示するプログラムを作成する。
